...
import { PatientController, PatientContollerImpl } from "../api/components/pacientes/controller";
...
describe('PatientController', () =>{
    ...
    beforeEach(() =>{
        ...
        patientController = new PatientContollerImpl(patientService)
    ...
    describe('getAllPatients',() => {
        it('should get all patients', async () => {
            ...
            const patients: Patient [] = [
                { id_paciente: 1, nombre: 'Andres', apellido: 'Galindo', identificacion: '1033342134', telefono: 1234567},
                { id_paciente: 1, nombre: 'Camilo', apellido: 'Ramirez', identificacion: '1000566322', telefono: 5655234}
            ];
            ...
            expect(mockRes.status).toHaveBeenNthCalledWith(200)
        })
    ...
    describe('createPatient', () =>{
        it('should create a new patient and return info', async () => {
            //Mock Process
            const patientRes : Patient = {id_paciente: 1, nombre: 'Andres', apellido: 'Galindo', identificacion: '1033342134', telefono: 1234567}
            const patientReq: PatientReq = {
                nombre: 'Andres',
                apellido: 'Galindo',
                identificacion: '1033342134',
                telefono: 1234567
            };
            (mockReq.body as PatientReq) = patientReq;
            (patientService.createPatient as jest.Mock).mockRejectedValue(patientRes)

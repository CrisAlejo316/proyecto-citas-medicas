...
describe('', () => {
    ...
    describe('createPatient', () => {
        it('should create a new patient and return it from service', async () => {
            ...
            const patientReq: PatientReq = { nombre: 'Andres', apellido: 'Galindo', identificacion: '1033342134', telefono: 1234567};
    ...
    describe('getPatientById', () => {
        it('should get patient by id from service', async () => {
            //Mock Process
            const patient: Patient = {id_paciente: 1, nombre: 'Andres', apellido: 'Galindo', identificacion: '1033342134', telefono: 1234567}
            const patientId = 1;
            ...
            // Asserts
            expect(patientRepository.getPatientById).toHaveBeenLastCalledWith(patientId

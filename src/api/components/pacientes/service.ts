import { PatientCreationError, PatientDeleteError, PatientUpdateError, RecordNotFoundError } from "../../../config/customErrors";
...
export class PatientServiceImpl implements PatientService {
    ...
    public createPatient(patientReq: PatientReq): Promise<Patient> {
        try{
            ...
            throw new PatientCreationError('Fialed to create patient from service')
        }
    }
